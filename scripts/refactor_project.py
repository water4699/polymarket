...
IMPORT_FIXES = {
    # data_manager 相关
    r'from db.data_manager import': 'from db.data_manager import',
    r'import db.data_manager': 'import db.data_manager',

    # migration_manager 相关
    r'from db.migration_manager import': 'from db.migration_manager import',
    r'import db.migration_manager': 'import db.migration_manager',

    # migration_templates 相关
    r'from db.migration_templates import': 'from db.migration_templates import',
    r'import db.migration_templates': 'import db.migration_templates',

    # migration_quickstart 相关
    r'from db.migration_quickstart import': 'from db.migration_quickstart import',
    r'import db.migration_quickstart': 'import db.migration_quickstart',

    # init_database 相关
    r'from db.init_database import': 'from db.init_database import',
    r'import db.init_database': 'import db.init_database',
}
    ...
    def fix_test_imports(self):
        ...
        for test_file in tests_dir.rglob('*.py'):
            try:
                ...
                # 修正import路径
                content = re.sub(r'from db.data_manager import', 'from db.data_manager import', content)
                content = re.sub(r'from db.migration_manager import', 'from db.migration_manager import', content)
                content = re.sub(r'from db.migration_templates import', 'from db.migration_templates import', content)
